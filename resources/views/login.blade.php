          ...
          <div class="row d-flex align-items-center justify-content-center h-100">
            ...
            <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
              <form>
                ...
                <h3 class="fw-normal mb-3 pb-3"">{{ __('form.login') }}</h3>
                ...
                <div class="d-flex justify-content-around align-items-center mb-4">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label" for="form1Example3">{{ __('form.remember') }}</label>
                  </div>
                  <a href="#!">{{ __('form.forgotpw') }}</a>
                </div>
      
                <!-- Submit button -->
                <button type="submit" class="btn btn-primary btn-lg btn-block">{{ __('form.login') }}</button>
