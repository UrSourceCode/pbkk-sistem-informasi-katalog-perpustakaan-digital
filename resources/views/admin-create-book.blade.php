                ...
                <div class="row page-bg">
                    <div class="p-4 col-md-12">
                        <div class="text-center top-icon">
                            <h1 class="mt-3">{{ __('crud.add') }} {{ __('nav.books') }}</h1>
                            <br>
                            ...
                            <form id="form-login" action="{{ route('create.book') }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Apakah Anda Yakin Tambah Data ?');">
                              ...
                              <div>
                                <input class="mt-3 form-control form-control-lg @error('publisher') is-invalid @enderror" name="publisher" type="text"
                                       placeholder="Publisher" value="" autofocus required>
                            </div>
                            ...
                            @enderror
                                ...
                                <div>
                                    <input class="mt-3 form-control form-control-lg @error('year') is-invalid @enderror" name="year" type="text"
                                           placeholder="Year" value="" autofocus required>
                                </div>
                                ...
                                <div>
                                  <input class="mt-3 form-control form-control-lg @error('category') is-invalid @enderror" name="category" type="text"
                                         placeholder="Category" value="" autofocus required>
                              </div>
                              ...
                              <div>
                                <input class="mt-3 form-control form-control-lg @error('isbn') is-invalid @enderror" name="isbn" type="text"
                                       placeholder="ISBN" value="" autofocus required>
                            </div>
                            ...
                            <div>
                              <input class="mt-3 form-control form-control-lg @error('synopsis') is-invalid @enderror" name="synopsis" type="text"
                                     placeholder="Synopsis" value="" autofocus required>
                          </div>
